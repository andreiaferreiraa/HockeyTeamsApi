    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HockeyTeamAPI.Models.HockeyDB>
    {
        ...
        protected override void Seed(HockeyTeamAPI.Models.HockeyDB context)
        {
            ...
            var jogadores = new List<Jogadores> {
                ...
                //Benfica
               new Jogadores {ID=1, Nome="Pedro Henriques", NomeCompleto="Pedro Miguel Rodrigues Vicente Henriques", Posicao="Guarda Redes", DataNascimento= new DateTime(1990,09,27), Nacionalidade="Portugal", Altura=1.86 , Peso=82.0, Fotografia="PedroHenriques.jpg", EquipaPK=1 },
               new Jogadores {ID=2, Nome="Diogo Rafael", NomeCompleto="Diogo Miguel Rafael", Posicao="Defesa/Médio", DataNascimento=new DateTime(1989,11,17), Nacionalidade="Portugal", Altura=1.71, Peso=79.2, Fotografia="DiogoRafael.jpg", EquipaPK=1  },
               new Jogadores {ID=3, Nome="Miguel Rocha", NomeCompleto="Miguel Damião Rocha", Posicao="Avançado", DataNascimento=new DateTime(1993,01,05), Nacionalidade="Portugal", Altura=1.85, Peso=80.1, Fotografia="MiguelRocha.jpg", EquipaPK=1 },
               new Jogadores {ID=4, Nome="Carlos Nicolía", NomeCompleto="Carlos Fernando Nicolía Heras", Posicao="Avançado", DataNascimento=new DateTime(1986,04,04), Nacionalidade="Argentina", Altura=1.80, Peso=79.0, Fotografia="CarlosNicolia.jpg", EquipaPK=1 },
               new Jogadores {ID=5, Nome="João Rodrigues", NomeCompleto="João Miguel Brazão Rodrigues", Posicao="Avançado", DataNascimento=new DateTime(1990,07,15), Nacionalidade="Portugal", Altura=1.85, Peso=84.4, Fotografia="JoaoRodrigues.jpg", EquipaPK=1 },
               
               //Sporting
               new Jogadores {ID=6, Nome="Ângelo Girão", NomeCompleto="Ângelo André Ferreira Girão", Posicao="Guarda Redes", DataNascimento=new DateTime(1989,08,28), Nacionalidade="Portugal", Altura=1.76, Peso=87.2, Fotografia="AngeloGirao.jpg", EquipaPK=2 },
               new Jogadores {ID=7, Nome="Ferran Font", NomeCompleto="Ferran Font i Sánchez", Posicao="Defesa/Médio", DataNascimento=new DateTime(1996,11,12), Nacionalidade="Espanha", Altura=1.70, Peso=82.7, Fotografia="FerranFont.jpg", EquipaPK=2 },
               new Jogadores {ID=8, Nome="Caio", NomeCompleto="Ricardo do Carmo Oliveira", Posicao="Defesa/Médio", DataNascimento= new DateTime(1982,01,05), Nacionalidade="Portugal", Altura=1.79, Peso=78.0, Fotografia="Caio.jpg", EquipaPK=2  },
               new Jogadores {ID=9, Nome="Pedro Gil", NomeCompleto="Pedro Gil Gómez", Posicao="Avançado", DataNascimento=new DateTime(1980,04,26), Nacionalidade="Espanha", Altura=1.87, Peso=83.8, Fotografia="PedroGil.jpg", EquipaPK=2 },
               new Jogadores {ID=10, Nome="João Pinto", NomeCompleto="João Pedro Garcia Santos Pinto", Posicao="Avançado", DataNascimento=new DateTime(1987,01,28), Nacionalidade="Angola", Altura=1.75, Peso=78.3, Fotografia="JoaoPinto.jpg", EquipaPK=2 },
              
                //FC Porto
               new Jogadores {ID=11, Nome="Carles Grau", NomeCompleto="Carles Grau Tallada", Posicao="Guarda Redes", DataNascimento=new DateTime(1990,03,10), Nacionalidade="Espanha", Altura=1.78, Peso=74.5, Fotografia="CarlesGrau.jpg", EquipaPK=3  },
               new Jogadores {ID=12, Nome="Hélder Nunes", NomeCompleto="Hélder Pereira Nunes", Posicao="Defesa/Médio", DataNascimento=new DateTime(1994,02,23), Nacionalidade="Portugal", Altura=1.78, Peso=89.3, Fotografia="HelderNunes.jpg", EquipaPK=3   },
               new Jogadores {ID=13, Nome="Rafa Costa", NomeCompleto="José Rafael Soares Costa", Posicao="Avançado", DataNascimento=new DateTime(1991,11,10), Nacionalidade="Portugal", Altura=1.83, Peso=87.2, Fotografia="RafaCosta.jpg", EquipaPK=3   },
               new Jogadores {ID=14, Nome="Jorge Silva", NomeCompleto="Jorge Miguel Sousa Silva", Posicao="Avançado", DataNascimento=new DateTime(1984,05,09), Nacionalidade="Portugal", Altura=1.87, Peso=81.3, Fotografia="JorgeSilva.jpg", EquipaPK=3   },
               new Jogadores {ID=15, Nome="Gonçalo Alves", NomeCompleto="Gonçalo Bonnet Alves", Posicao="Avançado", DataNascimento=new DateTime(1993,07,26), Nacionalidade="Portugal", Altura=1.78, Peso=80.0, Fotografia="GoncaloAlves.jpg", EquipaPK=3   },
              
               //UD Oliveirense
               new Jogadores {ID=16, Nome="Xavier Puigbí", NomeCompleto="Xavier Puigbí Martos", Posicao="Guarda Redes", DataNascimento=new DateTime(1987,05,23), Nacionalidade="Espanha", Altura=1.83, Peso=76.3, Fotografia="XavierPuigbi.jpg", EquipaPK=4  },
               new Jogadores {ID=17, Nome="Pedro Moreira", NomeCompleto="Pedro Miguel Santos Moreira", Posicao="Defesa/Médio", DataNascimento=new DateTime(1985,07,17), Nacionalidade="Portugal", Altura=1.78, Peso=70.0, Fotografia="PedroMoreira.jpg", EquipaPK=4  },
               new Jogadores {ID=18, Nome="Jordi Bargalló", NomeCompleto="Jordi Bargalló Poch", Posicao="Defesa/Médio", DataNascimento=new DateTime(1979,12,05), Nacionalidade="Espanha", Altura=1.69, Peso=65.0, Fotografia="JordiBargallo.jpg", EquipaPK=4  },
               new Jogadores {ID=19, Nome="João Souto", NomeCompleto="João Pedro Souto Silva", Posicao="Avançado", DataNascimento=new DateTime(1992,07,26), Nacionalidade="Portugal", Altura=1.78, Peso=75.7, Fotografia="JoaoSouto.jpg", EquipaPK=4  },
               new Jogadores {ID=20, Nome="Ricardo Barreiros", NomeCompleto="Ricardo Jorge da Silva Barreiros", Posicao="Avançado", DataNascimento=new DateTime(1982,01,17), Nacionalidade="Portugal", Altura=1.81, Peso=79.0, Fotografia="RicardoBarreiros.jpg", EquipaPK=4  },
            
               //Sp. Tomar 
               new Jogadores {ID=21, Nome="Diogo Alves", NomeCompleto="Diogo Alves Fernandes", Posicao="Guarda Redes", DataNascimento=new DateTime(1997,02,04), Nacionalidade="Portugal", Altura=1.78, Peso=79.1, Fotografia="DiogoAlves.jpg", EquipaPK=5 },
               new Jogadores {ID=22, Nome="Pedro Martins", NomeCompleto="Pedro Miguel Silva Martins", Posicao="Defesa/Médio", DataNascimento=new DateTime(1995,05,18), Nacionalidade="Portugal", Altura=1.73, Peso=77.0, Fotografia="PedroMartins.jpg", EquipaPK=5  },
               new Jogadores {ID=23, Nome="João Sardo", NomeCompleto="João de Roma Sardo", Posicao="Avançado", DataNascimento=new DateTime(1996,02,15), Nacionalidade="Portugal", Altura=1.81, Peso=76.2, Fotografia="JoãoSardo.jpg", EquipaPK=5  },
               new Jogadores {ID=24, Nome="Ivo Silva", NomeCompleto="Ivo Emanuel Sousa Silva", Posicao="Avançado", DataNascimento=new DateTime(1990,04,01), Nacionalidade="Portugal", Altura=1.80, Peso=79.3, Fotografia="IvoSilva.jpg", EquipaPK=5  },
               new Jogadores {ID=25, Nome="Hernâni Diniz", NomeCompleto="Hernâni Pedro Batista Diniz", Posicao="Avançado", DataNascimento=new DateTime(1994,10,09), Nacionalidade="Portugal", Altura=1.81, Peso=79.4, Fotografia="HernaniDiniz.jpg", EquipaPK=5  },
