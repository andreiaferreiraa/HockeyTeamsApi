    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HockeyTeamAPI.Models.HockeyDB>
    {
        ...
        protected override void Seed(HockeyTeamAPI.Models.HockeyDB context)
        {
            ...
            var equipas = new List<Equipas> {
               new Equipas {ID=1, Nome="SL. BENFICA", NomeTodo="Sport Lisboa e Benfica", DataFundacao = new DateTime(1904,02,28), Pais = "Portugal", Cidade="Lisboa", Presidente="Luís Filipe Vieira", EpocaCampeonatoPortugues="1950/51, 1951/52, 1955/56, 1956/57, 1959/60, 1960/61, 1965/66, 1966/67, 1967/68, 1969/70, 1971/72, 1973/74, 1978/79, 1979/80, 1980/81, 1991/92, 1993/94, 1994/95, 1996/97, 1997/98, 2011/12, 2014/15, 2015/16", EpocaCampeonatoMetropolitano="1967, 1968, 1970, 1972, 1973, 1974", EpocaTacaPortugal="1962/63, 1977/78, 1978/79, 1979/80, 1980/81, 1981/82, 1990/91, 1993/94, 1994/95, 1999/00, 2000/01, 2001/02, 2009/10, 2013/14, 2014/2015", EpocaSupertacaAntonioLivramento="1993, 1995, 1997, 2001, 2002, 2010, 2012", Historia="Hóquei Patins é uma das modalidades mais antigas do Clube, sendo a equipa que a pratica há mais tempo a nível mundial. " +
               "A equipa principal do Benfica joga na primeira divisão da modalidade , sendo o clube com mais Campeonatos Nacionais e Campeonatos Metropolitanos ganhos. " +
               "Alguns dos seus jogadores são chamados para representar a Seleção Nacional, comoJoão Rodrigues, Diogo Rafael e Pedro Henriques.", Logotipo="Benfica.jpg", Plantel="BenficaPlantel.jpg"},
               new Equipas {ID=2, Nome="SPORTING", NomeTodo="Sporting Clube de Portugal", DataFundacao= new DateTime(1906,07,01), Pais="Portugal", Cidade="Lisboa", Presidente="Bruno de Carvalho", EpocaCampeonatoPortugues="1938/39, 1974/75, 1975/76, 1976/77, 1977/78, 1981/82, 1987/88, 2017/18", EpocaCampeonatoMetropolitano="", EpocaTacaPortugal="1976/77, 1977/78, 1983/84, 1989/90", EpocaSupertacaAntonioLivramento="1983, 2015", Historia="Hóquei patins é praticado pelo Sporting  desde 1924. Foi uma das melhores equipas do mundo entre os finais dos anos 1970 e início dos anos 1980. " +
               "Em 2005, a modalidade foi extinguida, tendo sido retomada em 2010, subindo à primeira divisão na época de 2011/2012, 2 anos após a subida. Nesta última época 2017/2018, sagrou-se campeã Nacional, feito que já não acontecia à 30 anos. O guarda-redes Ângelo Girão é chamado para representar a Seleção Nacional.", Logotipo="Sporting.jpg", Plantel="SportingPlantel.jpg"},
               new Equipas {ID=3, Nome="FC PORTO", NomeTodo="Futebol Clube do Porto", DataFundacao=new DateTime(1983,09,28), Pais="Portugal", Cidade="Porto", Presidente="Jorge Nuno de Lima Pinto da Costa", EpocaCampeonatoPortugues="1982/83, 1983/84, 1984/85, 1985/86, 1986/87, 1988/89, 1989/90, 1990/91, 1998/99, 1999/00, 2001/02, 2002/03, 2003/04, 2004/05, 2005/06, 2006/07, 2007/08, 2008/09, 2009/10, 2010/11, 2012/13, 2016/17", EpocaCampeonatoMetropolitano="1968/69", EpocaTacaPortugal="1982/83, 1984/85, 1985/86, 1986/87, 1988/89, 1995/96, 1997/98, 1998/99, 2004/05, 2005/06, 2007/08, 2008/09, 2012/13, 2015/16, 2016/17, 2017/18", EpocaSupertacaAntonioLivramento="1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1996, 1998, 1999, 2005, 2006, 2007, 2008, 2009, 2011, 2013, 2016, 2017", Historia="O Hóquei em Patins é uma das modalidades mais prestigiadas do Futebol Clube do Porto, sendo a segunda equipa nacional com mais campeonatos nacionais ganhos. Foi por onde passou como seccionista o atual presidentedo clube, Pinto da Costa. A prática desta modalidade foi iniciada em 1954, devido à vontade de muita gente como dirigentes e adeptos do clube,vontade essa motivada pelas excelentes prestações  da seleção nacional. Os jogadores Hélder Nunes, Rafael Costa e Gonçalo Alves, são chamados à Seleção Nacional.", Logotipo="Porto.jpg", Plantel="PortoPlantel.jpg"},
               new Equipas {ID=4, Nome="UD OLIVEIRENSE", NomeTodo="União Desportiva Oliveirense", DataFundacao=new DateTime(1922,10,25), Pais="Portugal", Cidade="Oliveira de Azeméis", Presidente="Horácio Bastos", EpocaCampeonatoPortugues="1986–87, 1996/97, 2003/04,2006/07, 2009/10, 2010/11, 2012/13", EpocaCampeonatoMetropolitano="", EpocaTacaPortugal="1996/97, 2010/11, 2011/12", EpocaSupertacaAntonioLivramento="", Historia="Terá sido em 1969 que se iniciou a criação da equipa de hóquei em patins  em Oliveira de Azeméis. A partir de janeiro de 1970, e por indicação da Federação Portugues de Patinagem, o Oliveirense passa a fazer parte da Associação de Patinagem de Aveiro.No entanto, nesta época o campeonato regional em Aveiro não se realizaria e a UD Oliveirense acabaria por disputar o Campeonato Regional do Porto, prova que servia de apuramento para a 2ª Divisão Nacional, sagrando-se campeã. Atualmente é considerada o '3º Grande' no Hóquei em Patins em Portugal, em conjunto com o FC Porto e o SL Benfica. Ricardo Barreiros foi um jogador do Oliveirense que já representou a Seleção Nacional, tal como João Souto.", Logotipo="Oliveirense.jpg", Plantel="OliveirensePlantel.jpg"},
               new Equipas {ID=5, Nome="Sp. TOMAR", NomeTodo="Sporting Clube de Tomar", DataFundacao=new DateTime(1915,02,26), Pais="Portugal", Cidade="Tomar", Presidente = "Ivo Santos", EpocaCampeonatoPortugues="", EpocaCampeonatoMetropolitano="", EpocaTacaPortugal="", EpocaSupertacaAntonioLivramento="", Historia="A modalidade de Hóquei em patins é a modalidade principal deste clube, sendo praticada desde 1950.Na época de 1980/81 sagra-se Campeão Nacional da 2ª Divisão Nacional passando, no ano seguinte a disputar o Campeonato Nacional da 1ª Divisão onde se mantém largos anos sempre em plano de evidência prestigiando Tomar e esta vasta Região da Zona Centro do País.Na época 2015/16, após vitória por 5-0 frente ao Valença HC na 2ª mão do apuramento do campeão, o O SC Tomar conseguiu o seu 4º campeonato nacional da 2ª divisão (1980/81, 1993/94, 1999/00 e 2015/16) após ter conquistado a subida e a 21ª presença na 1ª divisão nacional.Na época de 2016/17, a equipa sénior de hóquei em patins foi finalista da Taça de Portugal pela 1ª vez na sua história. O jogo da final foi frente ao FC Porto, clube que sagrou vencedor do troféu.", Logotipo="Tomar.jpg", Plantel="TomarPlantel.jpg"},
